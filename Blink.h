...
A pin is blinked automatically by one second intervals or by a specified 
interval
Methods:
...
void blink(bool value); //1s duration
void blink(bool value, int blinkLength); //blink duration
